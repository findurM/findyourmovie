  ...
  return (
      <>
        ...
        <div className="flex justify-between">
                <h1 className="text-4xl mb-10">인기 TV SHOW</h1>
                <select className="select select-primary w-full max-w-xs" onChange={changeCategory} ref={selectRef}>
                    ...
                    <option value='on_the_air'>방영중인 작품</option>
                    <option value='airing_today'>오늘 방송하는 작품</option>
                </select>
            </div>
            ...
            endMessage={
                ...
                <b className="text-2xl">모든 드라마를 가져왔습니다!</b>
                </p>
            }>
