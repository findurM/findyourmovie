...
export const fetchActorDetails = createAsyncThunk("actorDetails/fetchActorDetails", async (movieId: Number) => {
...
export const actorDetailsSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(
        fetchActorDetails.fulfilled.type,
        (state, action: PayloadAction<{ actors: ActorInfo[]; director: DirectorInfo }>) => {
